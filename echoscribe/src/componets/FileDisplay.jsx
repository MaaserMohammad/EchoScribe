...
export default function FileDisplay(props) {
  const { handleAudioReset, file, audioStrem } = props;
  return (
    <main
      className='flex-1 p-4 flex flex-col gap-3 text-center 
      sm:gap-4 md:gap-5 justify-center pb-20 w-fit max-w-full
      mx-auto'
    >
      ...
      <div className="flex items-center justify-between gap-4">
        ...
        <button className="specialBtn px-3 p-2 rounded-lg 
        text-blue-400 flex items-center gap-2 font-medium">
            <p>Transcribe</p>
